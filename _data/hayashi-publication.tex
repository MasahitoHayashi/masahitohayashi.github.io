...
\item
\textbf{M.~Hayashi},
Chapter 7: Foundation of Quantum Information in Part I Foundation of Quantum Technologies,
in \emph{Handbook of Quantum Innovation},
H. Katori, {\it et al} ed,
pp. 93-108,
NTS-book, Tokyo, 2026.
In Japanese. 
...
\item
K. Fang, \textbf{M.~Hayashi},
``Quantum Information Theory: Quantum Entropies and Their Roles in Quantum Information Processing,''
{\em Reference Module in Materials Science and Materials Engineering},
Elsevier, 2026,
https://doi.org/10.1016/B978-0-443-33965-3.00001-8.

\item
Z.~Li, H.~Zhu, and \textbf{M.~Hayashi},
``Robust Verification of Quantum States in the Adversarial Scenario,''
in \emph{Quantum Robustness in Artificial Intelligence},
M.~Usman, ed.,
Quantum Science and Technology,
pp.~389--411,
Springer, Cham, 2026.
doi:10.1007/978-3-032-11153-1\_16.
...
\item
\textbf{M. Hayashi}, L. Gao, H.-C. Cheng,
``Adversarial Hypothesis Testing for Quantum Channels,''
{\em Proc. 2026 IEEE Int. Symp. Information Theory (ISIT)}, 
Guangzhou, China.
June 28 - July 3, 2026 (In press).
...
\item
T. Matsuura, \textbf{M. Hayashi}, M.-H. Hsieh,
...
\item
K. Fang, \textbf{M. Hayashi}, 
``An almost complete picture of quantum state discrimination with composite correlated hypotheses,''
{\em Beyond IID conference},
The Chinese University of Hong Kong, Shenzhen, Shenzhen, China,
June, 22 -- 26, 2026.
...
K. Fang, \textbf{M. Hayashi}, 
``An almost complete picture of quantum state discrimination with composite correlated hypotheses,''
{\em Quantum Resources 2026}, Tokyo, Japan,
March, 16 -- 20, 2026.

\item
\textbf{M. Hayashi}, H. Yamasaki,
...
\item
\textbf{M. Hayashi}, 
``Comparison between indefinite causal order strategy nor adaptive strategy does not improve the estimation of group action via Bayesian approach,''
{\em The 18th World Meeting of the International Society for Bayesian Analysis}
WINC AICHI, Nagoya, Japan, June 28 - July 3, 2026.

\item
\textbf{M. Hayashi}, 
``Operational interpretation of the reverse sandwiched Renyi
divergences in composite quantum hypothesis testing,''
{\em  YPetz – Advances in quantum hypothesis testing and quantum entropies}, 
