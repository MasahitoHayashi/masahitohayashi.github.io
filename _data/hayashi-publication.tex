...
\begin{enumerate}
    \item
    Y. Chen and \textbf{M. Hayashi}, ``Adaptive Coding for Two-WayWiretap Channel under Strong Secrecy,'' 
    {\em Festschrift in Memory of Ning Cai Information Theory and Related Fields}, 
    Bielefeld, Germany, November 24--26, 2023 (In press).

    \item
    \textbf{M. Hayashi}, ``Secure network coding with adaptive and active attack,'' 
    {\em Festschrift in Memory of Ning Cai Information Theory and Related Fields}, 
    Bielefeld, Germany, November 24--26, 2023 (In press).

    \item
    \textbf{M. Hayashi}, ``Special functions in quantum phase estimation,'' 
    {\em Orthogonal Polynomials, Special Functions and Applications - Proceedings of the 16th International Symposium, Montreal, Canada, In honor to Richard Askey}, 
    Montreal, Canada, June 13--17, 2022 (Online). (In press).
